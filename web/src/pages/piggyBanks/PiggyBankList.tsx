...
import { getPiggyBanks } from '../../api/general';
...
const PiggyBankList: React.FC = () => {
  ...
  const columns = [
    ...
    { title: 'Target Amount', dataIndex: 'target_amount', key: 'target_amount' },
  ...
  return (
    <div>
      <Space style={{ marginBottom: 16, display: 'flex', justifyContent: 'space-between' }}>
        <Title level={4} style={{ margin: 0 }}>Piggy Banks</Title>
        <Button type="primary" icon={<PlusOutlined />}>Add Piggy Bank</Button>
      </Space>
