...
import { getRecurrences } from '../../api/general';
...
const RecurrenceList: React.FC = () => {
  ...
  const columns = [
    ...
    { title: 'First Date', dataIndex: 'first_date', key: 'first_date' },
  ...
  return (
    <div>
      <Space style={{ marginBottom: 16, display: 'flex', justifyContent: 'space-between' }}>
        <Title level={4} style={{ margin: 0 }}>Recurring Transactions</Title>
        <Button type="primary" icon={<PlusOutlined />}>Add Recurrence</Button>
      </Space>
